...
class VentanaPrincipal(tk.Tk):
    ...
    def init_menubar(self):
        ...
        self.menu_archivo, self.bar_menu = self.menuarchivo(self.menu_archivo, self.bar_menu)  # Función que añade 
        # submenus, etc 
        ...
        self.menu_editar, self.bar_menu = self.menueditar(self.menu_editar, self.bar_menu)  # Función que añade submenus
        ...
        self.menu_analizar, self.bar_menu = self.menuanalizar(self.menu_analizar, self.bar_menu)  # Función que añade
        # submenus, etc
        ...
        self.menu_herramienta, self.bar_menu = self.menuherramienta(self.menu_herramienta, self.bar_menu)  #Función que
        # añade submenus, etc
        ...
        self.menu_aplicacion, self.bar_menu = self.menuaplicacion(self.menu_aplicacion, self.bar_menu)  # Función que
        # añade submenus, etc
        ...
        self.menu_ventana, self.bar_menu = self.menuventana(self.menu_ventana, self.bar_menu)  # Función que añade
        # submenus, etc
        ...
        self.menu_ayuda, self.bar_menu = self.menuayuda(self.menu_ayuda, self.bar_menu)  # Función que añade submenus
